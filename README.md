...
OR
**Offline**: inside Mastectomic/docs folder
...
3. After the installation is completed, run `npm run dev` to launch the project in dev mode. It should automatically open the Mastectomic homepage in your browser at http://localhost:3000/
